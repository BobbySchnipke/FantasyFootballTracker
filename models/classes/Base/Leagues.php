 ...
 */
abstract class Leagues implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LeaguesTableMap';
    ...
    /**
     * The value for the league_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\Leagues object.
     */
    ...
    /**
     * Compares this with another <code>Leagues</code> instance.  If
     * <code>obj</code> is an instance of <code>Leagues</code>, delegates to
     * <code>equals(Leagues)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Leagues The current object, for fluid interface
     */
    ...
    /**
     * Get the [league_name] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Leagues The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LeaguesTableMap::COL_ID] = true;
        }
    ...
    public function setSite($v)
    {
        ...
        if ($this->site !== $v) {
            $this->site = $v;
            $this->modifiedColumns[LeaguesTableMap::COL_SITE] = true;
        }
    ...
    /**
     * Set the value of [league_name] column.
     *
     * @param string $v new value
     * @return $this|\Leagues The current object (for fluent API support)
     */
    public function setLeagueName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->league_name !== $v) {
            $this->league_name = $v;
            $this->modifiedColumns[LeaguesTableMap::COL_LEAGUE_NAME] = true;
        }
    ...
    public function setLeagueId($v)
    {
        ...
        if ($this->league_id !== $v) {
            $this->league_id = $v;
            $this->modifiedColumns[LeaguesTableMap::COL_LEAGUE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LeaguesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LeaguesTableMap::translateFieldName('Site', TableMap::TYPE_PHPNAME, $indexType)];
            $this->site = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LeaguesTableMap::translateFieldName('LeagueName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->league_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LeaguesTableMap::translateFieldName('LeagueId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->league_id = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = LeaguesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Leagues'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLeaguesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Leagues::setDeleted()
     * @see Leagues::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLeaguesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeaguesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->teamssScheduledForDeletion !== null) {
                if (!$this->teamssScheduledForDeletion->isEmpty()) {
                    \TeamsQuery::create()
                        ->filterByPrimaryKeys($this->teamssScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LeaguesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LeaguesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LeaguesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_SITE)) {
            $modifiedColumns[':p' . $index++]  = 'site';
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_LEAGUE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'league_name';
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_LEAGUE_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'site':
                        ...
                        break;
                    case 'league_name':
                        $stmt->bindValue($identifier, $this->league_name, PDO::PARAM_STR);
                        break;
                    case 'league_id':
                        $stmt->bindValue($identifier, $this->league_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = LeaguesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Leagues'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Leagues'][$this->hashCode()] = true;
        $keys = LeaguesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getSite(),
            $keys[2] => $this->getLeagueName(),
            $keys[3] => $this->getLeagueId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setSite($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setLeagueName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setLeagueId($arr[$keys[3]]);
        }
    }
    ...
    {
        $criteria = new Criteria(LeaguesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(LeaguesTableMap::COL_ID)) {
            $criteria->add(LeaguesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_SITE)) {
            $criteria->add(LeaguesTableMap::COL_SITE, $this->site);
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_LEAGUE_NAME)) {
            $criteria->add(LeaguesTableMap::COL_LEAGUE_NAME, $this->league_name);
        }
        if ($this->isColumnModified(LeaguesTableMap::COL_LEAGUE_ID)) {
            $criteria->add(LeaguesTableMap::COL_LEAGUE_ID, $this->league_id);
        }
    ...
    {
        $criteria = ChildLeaguesQuery::create();
        $criteria->add(LeaguesTableMap::COL_ID, $this->id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLeagueName($this->getLeagueName());
    ...
    public function initTeamss($overrideExisting = true)
    {
        ...
        $this->collTeamss = new $collectionClassName;
     ...
     * If this ChildLeagues is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLeagues The current object (for fluent API support)
     */
    ...
    public function addTeams(ChildTeams $l)
    {
        ...
        if (!$this->collTeamss->contains($l)) {
            ...
            if ($this->teamssScheduledForDeletion and $this->teamssScheduledForDeletion->contains($l)) {
                $this->teamssScheduledForDeletion->remove($this->teamssScheduledForDeletion->search($l));
            }
        }
    ...
    public function removeTeams(ChildTeams $teams)
    {
        if ($this->getTeamss()->contains($teams)) {
            ...
            $this->teamssScheduledForDeletion[]= clone $teams;
            $teams->setLeagues(null);
        }
    ...
    {
        return (string) $this->exportTo(LeaguesTableMap::DEFAULT_STRING_FORMAT);
    }
