...
abstract class Teams implements ActiveRecordInterface
{
    ...
    /**
     * The value for the team_owner field.
     *
     * @var        string
     */
    protected $team_owner;
    ...
    /**
     * Get the [team_owner] column value.
     *
     * @return string
     */
    ...
    public function setLeagueId($v)
    {
        ...
        if ($this->league_id !== $v) {
            $this->league_id = $v;
            $this->modifiedColumns[TeamsTableMap::COL_LEAGUE_ID] = true;
        }

        if ($this->aLeagues !== null && $this->aLeagues->getId() !== $v) {
            $this->aLeagues = null;
        }
    ...
    public function setTeamName($v)
    {
        ...
        if ($this->team_name !== $v) {
            $this->team_name = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TEAM_NAME] = true;
        }
    ...
    /**
     * Set the value of [team_owner] column.
     *
     * @param string $v new value
     * @return $this|\Teams The current object (for fluent API support)
     */
    public function setTeamOwner($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->team_owner !== $v) {
            $this->team_owner = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TEAM_OWNER] = true;
        }
    ...
    {
        if ($this->aLeagues !== null && $this->league_id !== $this->aLeagues->getId()) {
            $this->aLeagues = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aLeagues !== null) {
                if ($this->aLeagues->isModified() || $this->aLeagues->isNew()) {
                    $affectedRows += $this->aLeagues->save($con);
                }
                $this->setLeagues($this->aLeagues);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_OWNER)) {
            $modifiedColumns[':p' . $index++]  = 'team_owner';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'team_name':
                        ...
                        break;
                    case 'team_owner':
                        $stmt->bindValue($identifier, $this->team_owner, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aLeagues) {
                ...
                $result[$key] = $this->aLeagues->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_OWNER)) {
            $criteria->add(TeamsTableMap::COL_TEAM_OWNER, $this->team_owner);
        }
    ...
    /**
     * Declares an association between this object and a ChildLeagues object.
     *
     * @param  ChildLeagues $v
     * @return $this|\Teams The current object (for fluent API support)
     * @throws PropelException
     */
    public function setLeagues(ChildLeagues $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildLeagues object, it will not be re-added.
        if ($v !== null) {
            $v->addTeams($this);
        }
    ...
    /**
     * Get the associated ChildLeagues object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildLeagues The associated ChildLeagues object.
     * @throws PropelException
     */
    public function getLeagues(ConnectionInterface $con = null)
    {
        if ($this->aLeagues === null && ($this->league_id !== null)) {
            $this->aLeagues = ChildLeaguesQuery::create()->findPk($this->league_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeagues->addTeamss($this);
             */
        }

        return $this->aLeagues;
    }
    ...
    {
        if (null !== $this->aLeagues) {
            $this->aLeagues->removeTeams($this);
        }
        $this->id = null;
        $this->league_id = null;
        $this->team_name = null;
