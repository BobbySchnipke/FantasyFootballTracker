...
class TeamsTableMap extends TableMap
{
     ...
     */
    const COL_TEAM_NAME = 'teams.team_name';

    /**
     * the column name for the team_owner field
     */
    const COL_TEAM_OWNER = 'teams.team_owner';
    ...
    {
        $this->addRelation('Leagues', '\\Leagues', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':league_id',
    1 => ':id',
